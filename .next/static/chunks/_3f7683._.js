(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_3f7683._.js", {
            ...
            fetch("/world-map.svg").then({
                ...
                "WorldMap.useEffect": (svgContent)=>{
                    ...
                    if (mapContainer) {
                        ...
                        // Style all paths and add hover events
                        const allPaths = mapContainer.querySelectorAll("path");
                        allPaths.forEach({
                            "WorldMap.useEffect": (path)=>{
                                ...
                                path.addEventListener("mousemove", {
                                    "WorldMap.useEffect": (e)=>{
                                        const countryName = getCountryName(path.id);
                                        setTooltip({
                                            show: true,
                                            text: countryName,
                                            x: e.clientX,
                                        ...
                                        path.style.fill = "#D0D9DC"; // Hover color
                                    }
                                }["WorldMap.useEffect"]);
                                path.addEventListener("mouseleave", {
                                    "WorldMap.useEffect": ()=>{
                                        ...
                                        path.style.fill = "#ECEFF1"; // Reset color
                                    }
                                }["WorldMap.useEffect"]);
                            }
                        }["WorldMap.useEffect"]);
...
_s(WorldMap, "j3oISU7BQ4KuaZc9zJUEcz+tWJM=");
_c = WorldMap;
...
//# sourceMappingURL=_3f7683._.js.map